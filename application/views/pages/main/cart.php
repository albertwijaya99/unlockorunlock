	    	...
	    	<div class="modal-header">
	      	...
	      	<div class="modal-body" id="modall">
	      		...
	      		<div class="form-group">
	      			...
	      			<textarea  class="form-control" id="desc<?php echo $i?>"placeholder="Notes here" class="rounded" style="height:5rem; width:28rem; resize: none;"maxlength="120"><?php if(isset($product['Description'])){echo $product['Description'];}?></textarea>
	      		</div>
	      	</div>
